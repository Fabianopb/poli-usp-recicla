...
<tr>
	...
	<td align="center" colspan="2">
		<br><b>Usuários cadastrados</b><br><br>
		<?php

			$sql = mysql_query("SELECT * FROM usuarios ORDER BY nome");

			echo '<table class="produto" border="1" cellspacing="0" cellpadding="2" width="600"><tr><th>Nome</th><th>NºUSP</th><th>Função</th><th>Departamento</th><th>Laboratório</th><th>e-mail</th><th>Ramal</th></tr>';
