...
<tr>
	...
	<td align="center" colspan="2">
		<br><b>Cadastrar novo usuário</b><br>
		<font color="red">
		<?php
		...
		<table class="body" border="0"><tr><td align="right">
			<form method="post" action="cadastrado.php">
				...
				NºUSP: <input type="text" name="usuarioNumero" size="30"><br>
				Função: <input type="text" name="usuarioFuncao" size="30"><br>
				Departamento: <input type="text" name="usuarioDep" size="30"><br>
				Laboratório: <input type="text" name="usuarioLab" size="30"><br>
				e-mail: <input type="text" name="usuarioMail" size="30"><br>
				ramal: <input type="text" name="usuarioRamal" size="30"><br><br>
		</td></tr></table>				
				<input type="submit" value="Cadastrar"><br><br>
			</form>
		<font color="red">Atenção! Confira todos os dados antes de confirmar o cadastro.<br>Uma senha será gerada automaticamente e enviada para o e-mail cadastrado do usuário.</font>
	</td>
</tr>
